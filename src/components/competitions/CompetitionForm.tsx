                        ...
                        <form className="space-y-4 md:space-y-6">
                            ...
                            {Array.isArray(competition.locations) && competition.locations.length > 0 ? (
                                competition.locations.map(location => (
                                    <div key={location.id} className="pl-2">
                                        <div className="flex flex-row pb-2 justify-around text-white border-b border-[#D9B310] border-solid">
                                            <h3>{`Skupina ${location.id}`}</h3>
                                            <button className="flex items-center space-x-2 uppercase hover:text-red-600">                                                

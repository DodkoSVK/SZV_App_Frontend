...
const CompetitionForm: React.FC<Props> = (props) => {
    ...
    const handleRemoveLocation = () => {
        ...
        const lastItem = currentLocations[lastIndex];
    
        console.log(`🟢 Odstraňujem lokalitu s ID: ${lastItem?.id ?? "neznámy"}`);
                ...
                <CardContent>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                            <FormField
                                ...
                                name="league_id"
                                render={({ field }) => (
                                    <FormItem className="w-full" data-cy="comp-league">
                            ...
                            <FormField
                                ...
                                name="date"
                                render={({ field }) => (
                                    <FormItem className="flex flex-col" data-cy="comp-date">
                                                    ...
                                                    >
                                                       {(() => {
                                                            ...
                                                            return parsedDate && isValid(parsedDate) ? (
                                                                format(parsedDate, "d. M. yyyy", { locale: sk })
                                                            ) : (
                            ...
                            {fields.length > 0 ? (
                                ...
                                >
                                    ...
                                    <Card key={field.id} className="w-full mb-4" data-cy="group-card">
                                        <CardHeader className="flex flex-col pb-1 pl-2">
                                            <div className="flex flex-row items-center justify-around w-full px-2">
                                                ...
                                                className="flex flex-row text-chart-5 gap-2 cursor-pointer transform transition-transform hover:scale-110"
                                                >
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                                            ...
                                            <div className="w-[95%] h-[1px] bg-foreground self-center mt-1" />
                                        </CardHeader>
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                            <FormItem className="w-full" data-cy="group-name">
                                        ...
                                        <FormField                                            
                                            ...
                                            render={({ field }) => (
                                            <FormItem className="w-full" data-cy="group-club">
